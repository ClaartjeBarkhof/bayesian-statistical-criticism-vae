...
run_script, job_paths = batch.generate([
    ("info_lambda_2", [0.1, 1.0, 100.0, 1000.0, 5000.0])],
    batch_size=64,
    # beta_beta=1.0,
    checkpointing=True,
    ...
    # info_lambda_2=500.0,
    iw_n_samples=10,
    # language_dataset_name="ptb_text_only",
    latent_dim=10,
    log_every_n_steps=5,
    logging=True,
    max_epochs=100,
    ...
    # mdr_value=16.0,
    # min_elbo_constraint_optim_lr=0.001,
    # min_elbo_constraint_value=90.0,
    # mmd_constraint_optim_lr=0.001,
    # mmd_constraint_value=0.01,
    mog_n_components=5,
    n_channels=1,
    num_workers=6,
    objective="INFO-VAE",
